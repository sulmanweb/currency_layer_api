...
class ClientTest < Minitest::Test
  def test_access_key
    client = CurrencyLayerApi::Client.new access_key: "test"
    assert_equal "test", client.access_key
  end

  def test_list
    stub = stub_request("list", response: stub_response(fixture: "list"))
    client = CurrencyLayerApi::Client.new(access_key: "fake", adapter: :test, stubs: stub)
    currency_list = client.list

    assert_equal CurrencyLayerApi::Currency, currency_list.first.class
  ...
  def test_live
    ...
    assert_equal CurrencyLayerApi::Conversion, conversion_list.first.class
  ...
  def test_error
    ...
    error = assert_raises(CurrencyLayerApi::Error) { client.list }
